...
const deployment = {
  ...
  'deployment.event.record': '操作记录',
  'deployment.event.result': '部署结果',
  'deployment.event.time': '部署时间',
  'deployment.event.operator': '操作人员',
  'deployment.event.empty': '暂无实例事件',
  'deployment.event.log': '查看日志详情',
  'deployment.event.status.create': '部署实例',
  'deployment.event.status.update': '更新实例',
  ...
  'deployment.networking.service': '网络名称',
  'deployment.networking.type': '网络类型',
  'deployment.networking.target': '目标对象',
  'deployment.networking.target.type': '目标对象类型',
  'deployment.networking.config': '配置类型',
  'deployment.networking.ip': '外部IP',
  'deployment.networking.port': '端口/目标端口',
  'deployment.networking.nport': '节点端口/端口/目标端口',
  'deployment.networking.instance.deleted': '实例已删除',
