...
databaseChangeLog(logicalFilePath: 'dba/devops_pipeline_stage_record.groovy') {
    ...
    changeSet(author: 'scp', id: '2019-04-18-devops_pipeline_stage-modify-column') {
        sql("ALTER TABLE devops_pipeline_stage_record MODIFY COLUMN `execution_time` VARCHAR(255)")
    }
    ...
    changeSet(author: 'scp', id: '2019-06-12-idx-pipeline-record-id') {
        createIndex(indexName: "devops_pipeline_stage_record_idx_pipeline_record_id ", tableName: "devops_pipeline_stage_record") {
