...
databaseChangeLog(logicalFilePath: 'dba/devops_pipeline_user_record_rel.groovy') {
    ...
    changeSet(author: 'scp', id: '2019-06-04-idx-project-id') {
        createIndex(indexName: "devops_purr_idx_task_record_id ", tableName: "devops_pipeline_user_record_rel") {
            column(name: "task_record_id")
        }
        createIndex(indexName: "devops_purr_idx_stage_record_id ", tableName: "devops_pipeline_user_record_rel") {
