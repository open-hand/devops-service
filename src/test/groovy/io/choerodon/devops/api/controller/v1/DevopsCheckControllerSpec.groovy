...
//        DependencyInjectUtil.setAttribute(iamRepository, "baseServiceClient", mockIamServiceClient)
...
//
//
//        ResponseEntity<List<BranchDTO>> branchRes = new ResponseEntity<>(Arrays.asList(createMockBranchDO()), HttpStatus.OK)
