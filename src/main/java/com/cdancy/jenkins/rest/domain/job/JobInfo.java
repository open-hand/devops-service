...
public abstract class JobInfo {
   ...
   @SerializedNames({"description", "displayName", "displayNameOrNull", "name", "url", "buildable", "builds", "color",
           ...
           "lastStableBuild", "lastSuccessfulBuild", "lastUnstableBuild", "lastUnsuccessfulBuild", "nextBuildNumber", "property",
   ...
   public static JobInfo create(String description, String displayName, String displayNameOrNull, String name,
                                ...
                                int nextBuildNumber, List<ParametersDefinitionProperty> property, QueueItem queueItem, boolean concurrentBuild) {
   ...
   public abstract List<ParametersDefinitionProperty> property();
