...
public class HostTemplateJobConfigService extends TemplateJobConfigService {
    ...
    private CiTplHostDeployInfoCfgVO fillHostDeployConfig(Long configId, boolean builtIn) {
        ...
        CiTemplatePipelineVO ciTemplatePipelineVO = (CiTemplatePipelineVO) UserSyncErrorBuilder.PipelineTemplateUtils.threadLocal.get();
        ...
        UserSyncErrorBuilder.PipelineTemplateUtils.threadLocal.remove();
