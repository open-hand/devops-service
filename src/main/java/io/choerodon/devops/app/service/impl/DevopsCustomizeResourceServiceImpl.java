...
public class DevopsCustomizeResourceServiceImpl implements DevopsCustomizeResourceService {
    ...
    public void deleteResource(Long projectId, Long resourceId) {
        ...
        if (devopsEnvFileResourceDTOS.size() == 1) {
            ...
            gitlabServiceClientOperator.updateFile(devopsEnvironmentDTO.getGitlabEnvProjectId().intValue(), devopsCustomizeResourceDTO.getFilePath(), updateContent, String.format("remove from file: %s", devopsCustomizeResourceDTO.getFilePath()), TypeUtil.objToInteger(userAttrDTO.getGitlabUserId()), "master");
        }
    }
