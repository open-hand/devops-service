...
public class ConvertV1Beta1IngressServiceImpl extends ConvertK8sObjectService<V1beta1Ingress> {
    ...
    @Override
    public void checkIfExist(List<V1beta1Ingress> v1beta1Ingresses, Long
            envId, List<DevopsEnvFileResourceDTO> beforeSyncDelete, Map<String, String> objectPath, V1beta1Ingress
                                     v1beta1Ingress) {
    ...
    public ResourceType getType() {
        return ResourceType.V1BETA1_INGRESS;
    }
