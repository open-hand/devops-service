        ...
        if (devopsConfigDTO != null) {
            ...
            if (configVO.getPrivate() != null && configVO.getPrivate()) {
                ...
                if (devopsRegistrySecretDTO == null) {
                    ...
                    secretCode = String.format("%s%s%s%s%s%s%s%s", "secret-", devopsConfigDTO.getId(), "-", devopsEnvironmentDTO.getClusterId(), "-", devopsEnvironmentDTO.getId(), "-", appServiceDTO.getProjectId());
