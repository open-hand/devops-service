 ...
 */
@Service
public class JarAndImageDeployServiceImpl implements JarAndImageDeployService {

    private static final Logger LOGGER = LoggerFactory.getLogger(JarAndImageDeployServiceImpl.class);
