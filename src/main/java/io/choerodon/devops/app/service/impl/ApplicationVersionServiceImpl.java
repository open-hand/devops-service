...
public class ApplicationVersionServiceImpl implements ApplicationVersionService {
    ...
    private void createAutoDeployInstance(DevopsAutoDeployE devopsAutoDeployE, ApplicationVersionE applicationVersionE) {
        ...
        try {
            ...
            sagaClient.startSaga("devops-create-auto-deploy-instance", new StartInstanceDTO(input, "env", devopsAutoDeployE.getId().toString(), ResourceLevel.PROJECT.value(), devopsAutoDeployE.getProjectId()));
        } catch (Exception e) {
