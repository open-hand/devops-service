...
public class DevopsEnvUserPermissionRepositoryImpl implements DevopsEnvUserPermissionRepository {
    ...
    @Override
    public void baseCreate(DevopsEnvUserPermissionE devopsEnvUserPermissionE) {
    ...
    @Override
    public List<DevopsEnvUserPermissionE> baseListAll(Long envId) {
    ...
    @Override
    public List<DevopsEnvUserPermissionE> baseListByUserId(Long userId) {
        DevopsEnvUserPermissionDO devopsEnvUserPermissionDO = new DevopsEnvUserPermissionDO();
