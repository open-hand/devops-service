...
public enum GitOpsObjectError {
    ...
    RELEASE_APP_SERVICE_ID_NOT_EXIST("release.app.service.id.not.exist"),
    ...
    CERT_API_VERSION_NOT_SUPPORTED("cert.api.version.not.supported"),
    CERT_API_VERSION_TOO_OLD("cert.api.version.too.old"),
    CERT_MANAGER_NOT_INSTALLED("cert.manager.not.installed"),
    ...
    CERT_SECRET_NAME_SHOULD_EQUAL_TO_NAME("cert.secret.name.should.equal.to.name"),
    CERT_ISSUER_REF_EMPTY("cert.issuer.ref.empty"),
    ...
    PERSISTENT_VOLUME_METADATA_NOT_FOUND("devops.pv.metadata.not.found"),
    PERSISTENT_VOLUME_NAME_NOT_FOUND("devops.pv.name.not.found"),
    PERSISTENT_VOLUME_CAPACITY_NOT_FOUND("devops.pv.capacity.not.found"),
    PERSISTENT_VOLUME_STORAGE_NOT_FOUND("devops.pv.storage.not.found"),
    PERSISTENT_VOLUME_ACCESS_MODE_NOT_FOUND("devops.pv.access.mode.not.found"),
    PERSISTENT_VOLUME_ACCESS_MODE_SIZE_NOT_SUPPORTED("devops.pv.access.mode.size.not.supported"),
    PERSISTENT_VOLUME_TYPE_NOT_FOUND("devops.pv.type.not.found"),
    PERSISTENT_VOLUME_TYPE_MULTI("devops.multi.pv.type.not.valid"),
    PERSISTENT_VOLUME_NFS_PATH_NOT_FOUND("devops.pv.nfs.path.not.found"),
    PERSISTENT_VOLUME_NFS_SERVER_NOT_FOUND("devops.pv.nfs.server.not.found"),
    PERSISTENT_VOLUME_NFS_SERVER_NOT_IP("devops.pv.nfs.server.not.ip"),
    PERSISTENT_VOLUME_HOSTPATH_PATH_NOT_FOUND("devops.pv.hostpath.path.not.found"),
    PERSISTENT_VOLUME_LOCAL_PATH_NOT_FOUND("devops.pv.local.path.not.found"),
    PERSISTENT_VOLUME_LOCAL_PATH_NODE_AFFINITY_NOT_FOUND("devops.pv.local.nodeName.not.found"),
    PERSISTENT_VOLUME_LOCAL_PATH_NODE_NAME_MORE_THAN_ONE("devops.pv.local.nodeName.count.more.than.one"),
    PERSISTENT_VOLUME_UNMODIFIED("devops.pv.is.unmodified"),
    OBJECT_EXIST("object.exist"),
    FILE_NOT_YAML("devops.file.not.yaml.format"),
