...
public enum GitOpsObjectError {
    ...
    RELEASE_REPO_URL_NOT_FOUND("The C7nHelmRelease does not define repoUrl properties in spec"),
    RELEASE_API_VERSION_NOT_FOUND("The C7nHelmRelease does not define apiVersion properties"),
    ...
    SERVICE_API_VERSION_NOT_FOUND("The V1service does not define apiVersion properties"),
    SERVICE_RELATED_INGRESS_NOT_FOUND("the related service of the ingress not exist:"),
    ...
    INGRESS_API_VERSION_NOT_FOUND("The v1beta1Ingress does not define apiVersion properties"),
