 ...
 */
@Service
public class IamUserConvertor implements ConvertorI<UserE, IamUserDTO, io.choerodon.devops.api.vo.IamUserDTO> {

    @Override
    public UserE doToEntity(IamUserDTO dataObject) {
    ...
    @Override
    public io.choerodon.devops.api.vo.IamUserDTO entityToDto(UserE userE) {
        io.choerodon.devops.api.vo.IamUserDTO userDTO = new io.choerodon.devops.api.vo.IamUserDTO();
