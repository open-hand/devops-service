 ...
 */
@RestController("ciProjectTemplateVariableController.v1")
@RequestMapping("/v1/project/{project_id}/ci_template_variable")
public class CiProjectTemplateVariableController {
