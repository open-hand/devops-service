...
public class CiSitePipelineTemplateController extends BaseController {
    ...
    public ResponseEntity<Page<CiTemplatePipelineVO>> pagePipelineTemplate(
        ...
        return ResponseEntity.ok(ciPipelineTemplateBusService.pagePipelineTemplate(sourceId, ResourceLevel.SITE.value(), pageRequest, name, categoryId, builtIn, enable, params));
    }
    ...
    public ResponseEntity<CiTemplatePipelineVO> createPipelineTemplate(
        ...
        return ResponseEntity.ok(ciPipelineTemplateBusService.createPipelineTemplate(sourceId, ResourceLevel.SITE.value(), devopsPipelineTemplateVO));
    }
    ...
    public ResponseEntity<CiTemplatePipelineVO> updatePipelineTemplate(
        ...
        return ResponseEntity.ok(ciPipelineTemplateBusService.updatePipelineTemplate(sourceId, ResourceLevel.SITE.value(), devopsPipelineTemplateVO));
    }
