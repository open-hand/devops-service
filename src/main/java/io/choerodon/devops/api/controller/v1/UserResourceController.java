...
public class UserResourceController {
    ...
    @GetMapping("/general")
    public ResponseEntity<GeneralResourceVO> queryGeneral(
            @ApiParam("组织id")
    ...
    @Permission(permissionLogin = true)
    @GetMapping("/host")
    public ResponseEntity<List<HostDetailResourceVO>> queryHostResource(
            @ApiParam("组织id")
            @PathVariable("organization_id") Long organizationId) {
    ...
    @Permission(permissionLogin = true)
    @GetMapping("/cluster")
    public ResponseEntity<List<ClusterDetailResourceVO>> queryClusterResource(
            @ApiParam("组织id")
            @PathVariable("organization_id") Long organizationId) {
