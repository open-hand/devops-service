...
@RestController("ciProjectTemplateCategoryController.v1")
@RequestMapping("/v1/project/{project_id}/ci_template_category")
public class CiProjectTemplateCategoryController extends BaseController {

    @Autowired
    private CiTemplateCategoryBusService ciTemplateCategoryBusService;

    @ApiOperation(value = "项目层查询流水线分类")
    @GetMapping
    ...
    @ApiOperation(value = "项目层查询流水线分类列表")
    @Permission(level = ResourceLevel.ORGANIZATION)
    @GetMapping("/list")
