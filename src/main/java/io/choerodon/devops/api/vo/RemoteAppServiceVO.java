 ...
 */
public class RemoteAppServiceVO {
    ...
    public RemoteAppServiceVO setId(Long id) {
        this.id = id;
        return this;
    }
    ...
    public RemoteAppServiceVO setImgUrl(String imgUrl) {
        this.imgUrl = imgUrl;
        return this;
    }
    ...
    public RemoteAppServiceVO setCategory(String category) {
    ...
    public RemoteAppServiceVO setDescription(String description) {
    ...
    public RemoteAppServiceVO setContributor(String contributor) {
    ...
    public RemoteAppServiceVO setFree(Boolean free) {
        this.free = free;
        return this;
    }
    ...
    public RemoteAppServiceVO setBought(Boolean bought) {
        this.bought = bought;
        return this;
    }
