...
databaseChangeLog(logicalFilePath: 'dba/devops_pvc.groovy') {
    changeSet(author: 'lihao', id: '2019-11-01-create-table') {
        createTable(tableName: "devops_pvc", remarks: 'k8s PVC') {
            ...
            column(name: 'name', type: 'VARCHAR(30)', remarks: 'PVC名称')
            ...
            column(name: 'commandStatus', type: 'VARCHAR(32)', remarks: 'PVC状态')
        ...
        createIndex(indexName: "idx_name", tableName: "devops_pvc") {
            column(name: "name")
        }
    }
}
