...
databaseChangeLog(logicalFilePath: 'dba/devops_pipeline_audit_user_record.groovy') {
    changeSet(author: 'wanghao', id: '2022-11-02-create-table') {
        createTable(tableName: "devops_pipeline_audit_user_record", remarks: '人工卡点用户审核记录表') {
