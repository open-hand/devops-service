...
databaseChangeLog(logicalFilePath: 'dba/devops_app_service_image_version.groovy') {
    changeSet(author: 'wanghao', id: '2022-07-13-create-table') {
        createTable(tableName: "devops_app_service_image_version", remarks: '应用版本表') {
        ...
        addUniqueConstraint(tableName: 'devops_app_service_image_version',
                constraintName: 'devops_app_service_image_version_u1', columnNames: 'app_service_version_id')
    }
}