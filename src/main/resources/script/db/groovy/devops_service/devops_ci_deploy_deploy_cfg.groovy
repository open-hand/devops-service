...
databaseChangeLog(logicalFilePath: 'dba/devops_ci_deploy_deploy_cfg.groovy') {
    changeSet(author: 'wanghao', id: '2020-07-08-create-table') {
        createTable(tableName: "devops_ci_deploy_deploy_cfg", remarks: 'CI deployment部署任务配置表') {
    ...
    changeSet(author: 'wanghao', id: '2022-11-10-add-index') {
        createIndex(tableName: 'devops_ci_deploy_deploy_cfg', indexName: 'devops_ci_deploy_deploy_cfg_n1') {
