...
databaseChangeLog(logicalFilePath: 'dba/devops_ci_tpl_sonar_quality_gate_condition.groovy') {
    changeSet(author: 'lihao', id: '2022-11-18-create-table') {
        createTable(tableName: "devops_ci_tpl_sonar_quality_gate_condition", remarks: 'ci sonar配置 质量门条件表') {
        ...
        createIndex(tableName: 'devops_ci_tpl_sonar_quality_gate_condition', indexName: 'devops_ci_tpl_sonar_quality_gate_condition_n1') {
            column(name: 'gate_id')
        }
    }
}