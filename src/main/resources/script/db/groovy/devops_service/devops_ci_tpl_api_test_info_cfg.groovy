...
databaseChangeLog(logicalFilePath: 'dba/devops_ci_tpl_api_test_info_cfg.groovy') {
    changeSet(author: 'lihao', id: '2022-11-07-create-table') {
        createTable(tableName: "devops_ci_tpl_api_test_info_cfg", remarks: 'CI API测试任务配置信息表') {
    ...
    changeSet(author: 'wanghao', id: '2022-11-10-add-index') {
        createIndex(tableName: 'devops_ci_tpl_api_test_info_cfg', indexName: 'devops_ci_tpl_api_test_info_cfg_n1') {
