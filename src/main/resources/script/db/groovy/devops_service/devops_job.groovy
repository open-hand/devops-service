...
databaseChangeLog(logicalFilePath: 'dba/devops_job.groovy') {
    changeSet(author: 'lihao', id: '2021-06-08-create-table') {
        createTable(tableName: "devops_job", remarks: 'job资源表') {
        ...
        addUniqueConstraint(tableName: 'devops_job',
                constraintName: 'uk_env_id_name', columnNames: 'env_id,name')

        createIndex(indexName: "idx_env_id", tableName: "devops_job") {
            column(name: "env_id")
        }
    }
    ...
    changeSet(author: 'lihao',id: '2021-11-02-drop-index'){
        dropIndex(indexName: "idx_env_id", tableName: "devops_job")
    }
