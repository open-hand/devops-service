...
databaseChangeLog(logicalFilePath: 'dba/devops_ci_vuln_scan_config.groovy') {
    changeSet(author: 'wanghao', id: '2023-05-31-create-table') {
        createTable(tableName: "devops_ci_vuln_scan_config", remarks: 'ci 漏洞扫描配置信息表') {
        ...
        addUniqueConstraint(tableName: 'devops_ci_vuln_scan_config',
